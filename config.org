  ...
  (use-package hydra
    ...
    (global-set-key
     ...
     (defhydra hydra-paredit (:hint nil)
       ("k" paredit-forward-slurp-sexp "slurp-forward")
       ("j" paredit-forward-barf-sexp "barf-forward")
       ("d" paredit-backward-slurp-sexp "slurp-backward")
       ("f" paredit-backward-barf-sexp "barf-backward")
       ("u" undo-only "undo")
       ("q" nil "quit"))))
#+END_SRC
* magit
