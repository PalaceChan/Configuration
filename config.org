...
(use-package gptel
  ...
  (ava/add-or-update-openai-model 'gpt-5.4
                                  '(:description "Reasoning model designed to solve hard problems across domains"
                                                 :context-window 400
                                                 :input-cost 1.25
                                                 :output-cost 10
                                                 :cutoff-date "2024-10"
                                                 :request-params (:model "gpt-5.4" :stream t :reasoning_effort "low")))
  (ava/add-or-update-openai-model 'gpt5.4-thinking
                                  '(:description "Reasoning model designed to solve hard problems across domains"
                                                 :context-window 400
                                                 :input-cost 1.25
                                                 :output-cost 10
                                                 :cutoff-date "2024-10"
                                                 :request-params (:model "gpt-5.4" :stream t :reasoning_effort "xhigh")))
  (setq ava/openai-model-list
        (let ((desired-models '("gpt-5.4" "gpt5.4-thinking"))
              (result '()))
