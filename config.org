...
#+BEGIN_SRC emacs-lisp
  (use-package ediff
    ...
    :preface
    (defun ava/org-reveal-around-diff (&rest _)
        ...
        (when (and buf (buffer-live-p buf))
          (with-current-buffer buf
            (when (derived-mode-p 'org-mode)
              (org-reveal t))))))
    :config
    (advice-add 'ediff-next-difference :after #'ava/org-reveal-around-diff)
    (advice-add 'ediff-previous-difference :after #'ava/org-reveal-around-diff))
#+END_SRC
*** re-builder
...
#+BEGIN_SRC emacs-lisp
  (use-package clang-format
    ...
    (define-key c-mode-base-map "\C-cr" 'clang-format-region))
#+END_SRC
** company
*** company
#+BEGIN_SRC emacs-lisp
