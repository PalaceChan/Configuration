...
#+END_SRC
gets top answers to question on stackoverflow and renders in html
from: [[https://www.reddit.com/r/emacs/comments/cs6cb4/instant_stackoverflow_solutions_in_emacs_without/][reddit]]
#+BEGIN_SRC emacs-lisp
  (require 'cl)
  (require 'json)
  (defun ava/get-stackoverflow-answers (query)
