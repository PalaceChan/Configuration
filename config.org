...
(use-package gptel
  ...
  (ava/add-or-update-openai-model 'gpt-5.2
                                  '(:description "Reasoning model designed to solve hard problems across domains"
                                                 :context-window 400
                                                 :input-cost 1.25
                                                 :output-cost 10
                                                 :cutoff-date "2024-10"
                                                 :request-params (:model "gpt-5.2" :stream t :reasoning_effort "low")))
  (ava/add-or-update-openai-model 'gpt5.2-thinking
                                  '(:description "Reasoning model designed to solve hard problems across domains"
                                                 :context-window 400
                                                 :input-cost 1.25
                                                 :output-cost 10
                                                 :cutoff-date "2024-10"
                                                 :request-params (:model "gpt-5.2" :stream t :reasoning_effort "high")))
  (setq ava/openai-model-list
        (let ((desired-models '("gpt-5.2" "gpt5.2-thinking"))
              (result '()))
